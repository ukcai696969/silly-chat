...
async def sendAllWelcome(ctx):
    ...
    embed.add_field(
        name='Support & Bot Invite',
        value='[Support](https://discord.gg/3qvpkgWSbF)・[Bot invite](https://discord.com/api/oauth2/authorize?client_id=1051199485168066610&permissions=8&scope=bot%20applications.commands)',
        inline=False,
    )
...
async def on_guild_join(guild):
    ...
    if channel := bot.get_channel(c['logid']):
        embed = discord.Embed(
